...
-- 비밀번호: Test1234!@
INSERT INTO users (login_id, password_hash, referral_code, status, role, nickname, name, created_at, updated_at)
VALUES 
    -- testuser (ID:1): 일반 사용자 (레퍼럴 코드 있음)
    ('testuser', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'REF001', 'ACTIVE', 1, '테스트유저', '테스트유저', NOW(), NOW()),
    -- testuser2 (ID:2): 추가 테스트 사용자 (레퍼럴 코드 없음)
    ('testuser2', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', NULL, 'ACTIVE', 1, '테스트유저2', '테스트유저2', NOW(), NOW()),
    -- admin_user (ID:3): 관리자
    ('admin_user', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'ADMIN001', 'ACTIVE', 2, '관리자', '관리자', NOW(), NOW()),
    -- blocked_user (ID:4): 차단된 사용자 (레퍼럴 코드 없음 - 생성 테스트용)
    ('blocked_user', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', NULL, 'BLOCKED', 1, '차단유저', '차단유저', NOW(), NOW()),
    -- referrer_user (ID:5): 추천인 역할 (레퍼럴 코드 있음)
    ('referrer_user', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'REFER123', 'ACTIVE', 1, '추천인유저', '추천인유저', NOW(), NOW()),
    -- no_code_user (ID:6): 레퍼럴 코드 없는 사용자 (통계 조회 테스트용 피추천인)
    ('no_code_user', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', NULL, 'ACTIVE', 1, '코드없는유저', '코드없는유저', NOW(), NOW()),
    -- testuser1 (ID:7): 추가 테스트 사용자
    ('testuser1', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'TEST001', 'ACTIVE', 1, '테스트유저1', '테스트유저1', NOW() - INTERVAL '30 days', NOW()),
    -- testuser3 (ID:8): 추가 테스트 사용자
    ('testuser3', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'TEST003', 'ACTIVE', 1, '테스트유저3', '테스트유저3', NOW() - INTERVAL '10 days', NOW()),
    -- testuser4 (ID:9): 추가 테스트 사용자
    ('testuser4', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'TEST004', 'ACTIVE', 1, '테스트유저4', '테스트유저4', NOW() - INTERVAL '5 days', NOW()),
    -- testuser5 (ID:10): 비활성 사용자
    ('testuser5', '$2a$10$W84fmGkwKoh6wyU83VwQ8Ovw1wqZYxZ8E6RvWZzpwwZMLGNlSGtwa', 'TEST005', 'INACTIVE', 1, '테스트유저5', '테스트유저5', NOW() - INTERVAL '1 day', NOW()),
    -- admin1 (ID:11): 관리자
    ('admin1', '$2a$10$f7R8Z3w4fHCDjrgZ1bCo8OynXzErkt4c9TQHXxxmTE6BfOAvukDFG', NULL, 'ACTIVE', 2, '관리자1', '관리자1', NOW(), NOW())
